...
$sql = "SELECT patient.patientID, patient.fname, appointment.appointmentType, appointment.date, appointment.time
FROM appointment 
JOIN patient on appointment.patientID = patient.patientID
JOIN staff on appointment.chwID = staff.staffID
WHERE appointment.chwID = '" . $_SESSION['name'] . "' ORDER BY appointment.date DESC";
  ...
  <div id="main">
    <div id="header">
      ...
      <ul id="menu">
          ...
          <li class="selected"><a href="patientList.php">Patient List</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <h1>Patient List</h1>
        <label for="seach">Find a Patient or appointment</label>
        <?php
        echo '<input type="search" id="myInput" onkeyup="searchTable()" placeholder = "Enter any patient info">
        ';
