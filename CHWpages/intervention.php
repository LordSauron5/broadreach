  ...
  <div id="main">
    <div id="header">
      ...
      <ul id="menu">
          ...
          <li class="selected"><a href="intervention.php">Intervention</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <h1>Submit a new Intervention</h1>
        <div class="form_settings">
            <form action="interventionProcess.php" method="post">
            <p><span>Patient ID</span><input class="contact" type="text" name="patID" value="" required/></p>
            <p><span>Drug Administered</span><input class="contact" type="text" name="drug" value="" required/></p>
            <p><span>Comment</span><textArea class="contact" rows="4" cols="50" name="cmt"required></textArea></p>
