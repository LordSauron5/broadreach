  ...
  <div id="main">
    <div id="header">
      ...
      <ul id="menu">
          ...
          <li class="selected"><a href="viewStaff.php">View Staff</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <h1>All Staff</h1>
        <label for="seach">Find a Staff Member</label>
        <?php
        echo '<input type="search" id="myInput" onkeyup="searchTable()" placeholder = "Enter any Staff info">
        ';
