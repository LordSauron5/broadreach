  ...
  <div id="main">
    <div id="header">
      ...
      <ul id="menu">
          ...
          <li class="selected"><a href="viewAppointments.php">View Appointments</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <label for="seach">Find appointment</label>
        <?php
        echo '<input type="search" id="myInput" onkeyup="searchTable()" placeholder = "Enter any appoinment info">
        ';
