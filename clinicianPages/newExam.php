  ...
  <div id="main">
    <div id="header">
      ...
      <ul id="menu">
          ...
          <li class="selected"><a href="newExam.php">New Exam</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <h1>Conduct New Exam</h1>
        <div class="form_settings">
            <form action="examProcess.php" method="post">
            <p><span>ExaminerID</span><input class="contact" type="text" name="examiner_ID" value="" required/></p>
